...
$file{"1.patch"} = MIME::Base64::decode_base64(<<'___');
...
$file{"2.patch"} = MIME::Base64::decode_base64(<<'___');
...
$file{"3.patch"} = MIME::Base64::decode_base64(<<'___');
...
$file{"4.patch"} = MIME::Base64::decode_base64(<<'___');
...
$file{"5.patch"} = MIME::Base64::decode_base64(<<'___');
